...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.user'
        db.add_column(u'tracker_invoice', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['users.CustomUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.user'
        db.delete_column(u'tracker_invoice', 'user_id')
